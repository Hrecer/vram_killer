...
public class AtlasOptimizer {
	...
	public AtlasOptimizer() {
		...
		this.enabled = VRAMKillerConfigBase.Conversion.enabled;
	}
	...
	public boolean shouldUseAggressiveConversion(String atlasPath) {
		AtlasData data = atlasRegistry.get(atlasPath);
		if (data == null) return false;
		return data.currentEfficiency < 60.0;
	}
