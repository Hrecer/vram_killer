...
public class VRAMKillerSodiumEntryPoint implements ConfigEntryPoint {
    ...
    private static final StorageEventHandler STORAGE_HANDLER = VRAMConfig::save;
    ...
    public void registerConfigLate(ConfigBuilder builder) {
        ...
        modOptions.addPage(buildConversionPage(builder));
    ...
    private OptionPageBuilder buildDisplayPage(ConfigBuilder builder) {
        ...
        debugOverlayGroup.addOption(builder.createBooleanOption(Identifier.fromNamespaceAndPath(VRAMKiller.MOD_ID, "show_conversion_stats"))
                .setName(Component.translatable("config.vram_killer.display.debugOverlay_showConversionStats"))
                .setTooltip(Component.translatable("config.vram_killer.display.debugOverlay_showConversionStats.tooltip"))
                .setDefaultValue(VRAMKillerConfigBase.Display.DebugOverlay.showConversionStats)
                .setStorageHandler(STORAGE_HANDLER).setBinding(val -> VRAMKillerConfigBase.Display.DebugOverlay.showConversionStats = val,
                        () -> VRAMKillerConfigBase.Display.DebugOverlay.showConversionStats));
    ...
    private OptionPageBuilder buildConversionPage(ConfigBuilder builder) {
        OptionPageBuilder page = builder.createOptionPage();
        page.setName(Component.translatable("config.vram_killer.category.conversion"));
        ...
        mainGroup.addOption(builder.createBooleanOption(Identifier.fromNamespaceAndPath(VRAMKiller.MOD_ID, "conversion_enabled"))
                ...
                .setDefaultValue(VRAMKillerConfigBase.Conversion.enabled)
                .setStorageHandler(STORAGE_HANDLER).setBinding(val -> VRAMKillerConfigBase.Conversion.enabled = val,
                        () -> VRAMKillerConfigBase.Conversion.enabled));
        
        mainGroup.addOption(builder.createBooleanOption(Identifier.fromNamespaceAndPath(VRAMKiller.MOD_ID, "conversion_rgb5a1"))
                .setName(Component.translatable("config.vram_killer.compression_rgb5a1Conversion"))
                .setTooltip(Component.translatable("config.vram_killer.compression_rgb5a1Conversion.tooltip"))
                .setDefaultValue(VRAMKillerConfigBase.Conversion.rgb5a1Conversion)
                .setStorageHandler(STORAGE_HANDLER).setBinding(val -> VRAMKillerConfigBase.Conversion.rgb5a1Conversion = val,
                        () -> VRAMKillerConfigBase.Conversion.rgb5a1Conversion));

        mainGroup.addOption(builder.createIntegerOption(Identifier.fromNamespaceAndPath(VRAMKiller.MOD_ID, "conversion_min_texture_size"))
                .setName(Component.translatable("config.vram_killer.compression_minTextureSize"))
                .setTooltip(Component.translatable("config.vram_killer.compression_minTextureSize.tooltip"))
                .setDefaultValue(VRAMKillerConfigBase.Conversion.minTextureSize)
                .setValueFormatter(ControlValueFormatterImpls.number()).setRange(2, 64, 2)
                .setStorageHandler(STORAGE_HANDLER).setBinding(val -> VRAMKillerConfigBase.Conversion.minTextureSize = val,
                        () -> VRAMKillerConfigBase.Conversion.minTextureSize));

        mainGroup.addOption(builder.createBooleanOption(Identifier.fromNamespaceAndPath(VRAMKiller.MOD_ID, "conversion_async_processing"))
                .setName(Component.translatable("config.vram_killer.compression_asyncProcessing"))
                .setTooltip(Component.translatable("config.vram_killer.compression_asyncProcessing.tooltip"))
                .setDefaultValue(VRAMKillerConfigBase.Conversion.asyncProcessing)
                .setStorageHandler(STORAGE_HANDLER).setBinding(val -> VRAMKillerConfigBase.Conversion.asyncProcessing = val,
                        () -> VRAMKillerConfigBase.Conversion.asyncProcessing));
