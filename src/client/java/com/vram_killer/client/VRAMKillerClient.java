...
public class VRAMKillerClient implements ClientModInitializer {
	...
	private static void initializeSystems() {
		...
		VRAMKillerConfigBase configInstance = VRAMKiller.getConfigInstance();
		if (configInstance != null) {
			configInstance.syncToStaticFields();
		}
		...
		LOGGER.info("Compression | Scheduler | Upload interceptor | Shader optimizer");
		LOGGER.info("Animation optimizer | Atlas optimizer | Debug overlay | Compatibility checker - All online");
	}
